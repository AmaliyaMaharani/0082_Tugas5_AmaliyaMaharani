...
class BarangController
{
    ...
    public function index()
    {
        ...
        require_once __DIR__ . "/../views/barang/indexbrg.php";
    }

    public function create()
    {
        // Menampilkan form untuk tambah data barang
        require_once __DIR__ . "/../views/barang/createbrg.php";
    }
    ...
    public function edit($id)
    {
        ...
        if ($barang) {
            require_once __DIR__ . "/../views/barang/editbrg.php"; // Menampilkan form edit
        } else {
